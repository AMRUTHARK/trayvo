/**
 * Script to add round_off column to bills table
 * 
 * Usage: node database/migrate_bill_round_off.js
 * 
...
async function runMigration() {
  ...
  try {
    ...
    const sql = fs.readFileSync(path.join(__dirname, 'migration_bill_round_off.sql'), 'utf8');
